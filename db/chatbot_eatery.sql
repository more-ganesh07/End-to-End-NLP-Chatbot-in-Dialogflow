CREATE DATABASE  IF NOT EXISTS `chatbot_eatery` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chatbot_eatery`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: chatbot_eatery
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',6.00),(2,'Chole Bhature',7.00),(3,'Pizza',8.00),(4,'Mango Lassi',5.00),(5,'Masala Dosa',6.00),(6,'Biryani',9.00),(7,'Vada Pav',4.00),(8,'Puranpoli',7.00),(9,'Samosa',5.00), (10, 'Momos', 7.00);
...
--
-- Dumping routines for database 'chatbot_eatery'
--
